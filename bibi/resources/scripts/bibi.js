    ...
    0: function (e, t) {
        ...
        (function (t) {
            ...
            !function (i) {
                ...
                "use strict";
                var e, t, n, o, a, s, c, l, u, d, p, f, g = {version: "1.0.28"}, h = navigator.userAgent,
                    b = function (e) {
                ...
                return g.OperatingSystem = (e = {}, /Mac OS X/.test(h) ? /\(iP(hone|ad|od touch);/.test(h) ? e.iOS = b("CPU (iPhone )?OS", "$2") : void 0 !== document.ontouchend ? e.iOS = e.iPadOS = b() : /Mac OS X 10[\._]\d/.test(h) && (e.macOS = b("Mac OS X ")) : /Windows( NT)? \d/.test(h) ? e.Windows = 6 != (t = b("Windows( NT)?", "$2"))[0] ? t : t[1] >= 3 ? [8, 1] : t[1] >= 2 ? [8] : t[1] >= 1 ? [7] : t : /Android \d/.test(h) ? e.Android = b("Android") : /CrOS/.test(h) ? e.Chrome = b() : /X11;/.test(h) ? e.Linux = b() : /Firefox/.test(h) && (e.Firefox = b()), e), g.UserAgent = (n = {}, / Gecko\/\d/.test(h) ? (n.Gecko = b("rv"), / Waterfox\/\d/.test(h) ? n.Waterfox = b("Waterfox") : / Firefox\/\d/.test(h) && (n.Firefox = b("Firefox"))) : / Edge\/\d/.test(h) ? n.EdgeHTML = n.Edge = b("Edge") : / Chrom(ium|e)\/\d/.test(h) ? (n.Blink = n.Chromium = function (e) {
                    ...
                    var t = g.create("div", {innerHTML: e}), n = document.createDocumentFragment();
                    ...
                    _get_sMLStyle_sheet: function () {
                        ...
                        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++) n[i - 1] = arguments[i];
                        if (e instanceof Array) for (var r = e.length, o = 0; o < r; o++) {
                            var a;
                            (a = g.CSS).setStyle.apply(a, [e[o]].concat(n))
                        } else for (var s = n.length, c = 0; c < s; c++) for (var l in n[c]) e.style[l] = n[c][l];
                        ...
                        return new Promise((function (n) {
                            for (var r = e.getAttribute("style"), o = [r ? r.trim() : ""], a = i.length, s = 0; s < a; s++) for (var c in i[s]) {
                                var l = i[s][c];
                    ...
                    return this.add = function (e, n) {
                        ...
                        })), a.dispatchEvent(new CustomEvent(e, {detail: t})), t)
                    }, this
                }, g.Scroller = {
                    scrollTo: function (e) {
                        var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            o = e.Frame && e.Frame instanceof HTMLElement ? e.Frame : window, a = {};
                        if (o.sMLScrollerSetting ? (a = o.sMLScrollerSetting).cancel() : ((a = o.sMLScrollerSetting = {Frame: o}).scrollTo = a.Frame === window ? function (e, t) {
                        ...
                        }), e instanceof HTMLElement ? a.Target = g.Coord.getElementCoord(e) : a.Target = "number" == typeof e ? {Y: e} : e ? {
                            X: e.X,
                            Y: e.Y
                        ...
                        var e = this, t = this.Scrolling, n = (new Date).getTime() - t.StartedOn;
                    ...
                    read: function (e) {
                        ...
                        for (var t = document.cookie.split("; "), n = "", i = t.length, r = 0; r < i; r++) if (t[r].substr(0, e.length + 1) == e + "=") {
                    ...
                    selectRange: function (e) {
                        ...
                        var l = t.childNodes[o], u = 0, d = "", p = l.textContent.length - 1;
                        ...
                        var f = t.childNodes[a], g = "", h = f.textContent.length - 1;
                        ...
                        return {Start: {Node: l, Text: d}, End: {Node: f, Text: g}}
                    }, _flat: function (e) {
                        return e.replace(/[\r\n]/g, "")
                    }, _escape: function (e) {
        ...
        function c(e, t) {
            for (var n = {}, i = [], r = 0; r < e.length; r++) {
                var o = e[r], c = t.base ? o[0] + t.base : o[0], l = n[c] || 0, u = "".concat(c, " ").concat(l);
                n[c] = l + 1;
                var d = s(u), p = {css: o[1], media: o[2], sourceMap: o[3]};
        ...
        (function (e) {
            ...
            return new Promise((function (e, t) {
                ...
                F.book ? (U.isToBeExtractedIfNecessary(F.book) && (i = !0), F.zine && (r = !0)) : (F["accept-local-file"] || F["accept-blob-converted-data"]) && (i = r = !0), r && n.unshift("zine.js"), (i ? (F.book ? U.tryRangeRequest().then((function () {
                    ...
                    if (n.length && n.forEach((function (e) {
                        return F.extensions.unshift({src: new URL("../../extensions/" + e, x.Script.src).href})
            ...
            }) : F.book ? Promise.resolve({Book: F.book}) : F["accept-local-file"] ? new Promise((function (e) {
            ...
            return Promise.resolve().then((function () {
                ...
                if ("object" == I(_.StartOn)) {
                    var n = "object" == I(_.StartOn.Item) ? _.StartOn.Item : function () {
                        if ("number" == typeof _.StartOn.ItemIndex) {
                            ...
                            return e < 0 ? _.StartOn = {ItemIndex: 0} : e >= _.Items.length && (_.StartOn = {ItemIndex: _.Items.length - 1}), _.Items[_.StartOn.ItemIndex]
                        }
                        if ("number" == typeof _.StartOn.ItemIndexInSpine) {
                            ...
                            return n.Spread || (_.StartOn = {ItemIndex: 0}, n = _.Items[0]), n
                        }
                        if ("string" == typeof _.StartOn.P) {
                            var i = 1 * _.StartOn.P.split(".").shift() - 1;
                            return i < 0 ? (i = 0, _.StartOn = {P: String(i + 1)}) : i >= _.Items.length && (i = _.Items.length - 1, _.StartOn = {P: String(i + 1)}), _.Items[i]
                        }
                        if ("number" == typeof _.StartOn.IIPP) {
                            var r = Math.floor(_.StartOn.IIPP);
                            return r < 0 ? (r = 0, _.StartOn = {IIPP: r}) : r >= _.Items.length && (r = _.Items.length - 1, _.StartOn = {IIPP: r}), _.Items[r]
                        }
                        if ("string" == typeof _.StartOn.Edge) switch (_.StartOn = "foot" != _.StartOn.Edge ? {Edge: "head"} : {Edge: "foot"}, _.StartOn.Edge) {
                            case"head":
                                return _.Items[0];
                            case"foot":
                ...
                return _.Spreads.forEach((function (n) {
                    return e.push(new Promise((function (e) {
                        return k.loadSpread(n, {AllowPlaceholderItems: F["allow-placeholders"] && n.Index != t.TargetSpreadIndex}).then((function () {
            ...
            return new Promise((function (e) {
                ...
                H.History.List.length || (H.History.List = [{
                    ...
                    try {
                        U.Biscuits && U.Biscuits.memorize("Book", {Position: {IIPP: H.PageObserver.getIIPP()}})
                    } catch (e) {
                    }
            ...
            var e = x.IsDevMode = U.Body.appendChild(sML.create("div", {id: "bibi-is-dev-mode"}));
            ...
            if (x.Elements || (x.Elements = {}), window.customElements) x.Elements[r] || (x.Elements[r] = function (e) {
                ...
                return n
            }(m(HTMLElement)), window.customElements.define(r, x.Elements[r])); else if (document.registerElement) return x.Elements[r] || (x.Elements[r] = document.registerElement(r)), sML.edit(new (x.Elements[n.shift()]), n);
        ...
        var A = {
            ...
            Opened: !1, wait: function () {
                ...
                return new Promise((function (t, n) {
                    ...
                    if (A.Type = F.book ? F.zine ? "Zine" : "EPUB" : "", "EPUB" != A.Type && (A.ZineData = {Source: {Path: "zine.yaml"}}), "URI" == r) {
                        if (U.Local) return n("Bibi can't open books via ".concat(N.book ? "data-bibi-book" : "URL", " on local mode"));
                        A.Path = e.Book;
                        var o = ("Zine" == A.Type ? A.ZineData : A.Container).Source, a = [], s = function (e) {
                            return {
                        ...
                        var c, l = e.BookData,
                            u = {EPUB: /^application\/epub\+zip$/, Zine: /^application\/(zip|x-zip(-compressed)?)$/};
                        if ("File" == r) {
                            ...
                            if ("Base64" == r) {
                                ...
                                try {
                                    ...
                                    if (!(l = new Blob([p.buffer], {type: e.BookDataMIMEType})) || !l.size || !l.type) throw""
                                } catch (e) {
        ...
        k.loadContainer.process = function (e) {
            ...
            var t = e.getElementsByTagName("package")[0], n = e.getElementsByTagName("metadata")[0],
                i = A.Package.Metadata, r = e.getElementsByTagName("manifest")[0], o = A.Package.Manifest,
                a = e.getElementsByTagName("spine")[0], s = A.Package.Spine, c = {},
                l = t.getAttribute("xmlns:dc") || n.getAttribute("xmlns:dc"), u = t.getAttribute("unique-identifier"),
                d = u ? e.getElementById(u) : null, p = d ? d.textContent : "";
            i["unique-identifier"] = p ? p.trim() : "", ["identifier", "language", "title", "creator", "publisher"].forEach((function (t) {
                ...
                if (!e.getAttribute("refines")) {
                    ...
                    if (t) /^dcterms:/.test(t) ? (i[t] || (i[t] = []), i[t].push(e.textContent.trim())) : i[t] = e.textContent.trim(); else {
            ...
            sML.forEach(a.getElementsByTagName("itemref"))((function (e) {
                ...
                var n = o[c[t]];
                if (!n) return !1;
                var r = sML.create("iframe", {className: "item", scrolling: "no", allowtransparency: "true"});
                if (r.idref = t, r.Source = n, r.AnchorPath = n.Path, r.FallbackChain = [], F["prioritise-fallbacks"]) for (; r.Source.fallback;) {
                ...
                if (l && (l = l.trim().replace(/\s+/g, " ").split(" ")).forEach((function (t) {
                ...
                })), r["rendition:layout"] = e["rendition:layout"] || i["rendition:layout"], r["rendition:orientation"] = e["rendition:orientation"] || i["rendition:orientation"], r["rendition:spread"] = e["rendition:spread"] || i["rendition:spread"], r["rendition:page-spread"] = e["rendition:page-spread"] || e["page-spread"] || void 0, r.IndexInSpine = s.push(r) - 1, "no" == e.getAttribute("linear")) r.linear = "no", r.IndexInNonLinearItems = _.NonLinearItems.push(r) - 1; else {
                    ...
                    if (r.IndexInSpread = u.Items.push(r) - 1, r.Box = u.appendChild(sML.create("div", {
                        ...
                        var p = sML.create("span", {className: "page", Spread: u, Item: r, IndexInItem: 0});
            ...
            return t.Info.innerHTML = n.Info.innerHTML = (e = [], A.Title && e.push("<strong>".concat(k.createCover.optimizeString(A.Title), "</strong>")), A.Creator && e.push("<em>".concat(k.createCover.optimizeString(A.Creator), "</em>")), A.Publisher && e.push("<span>".concat(k.createCover.optimizeString(A.Publisher), "</span>")), e.join(" ")), Promise.resolve(new Promise((function (e, t) {
                ...
                U.file(A.CoverImage.Source, {URI: !0}).then((function (t) {
                    n || e(t.URI)
                })).catch((function () {
                    n || t()
                })).then((function () {
            ...
            return U.openDocument(A.Nav.Source).then((function (e) {
                var t = H.Panel.BookInfo.Navigation = H.Panel.BookInfo.insertBefore(sML.create("div", {id: "bibi-panel-bookinfo-navigation"}), H.Panel.BookInfo.firstElementChild);
                t.innerHTML = "";
                ...
                if ("Navigation Document" == A.Nav.Type) sML.forEach(e.querySelectorAll("nav"))((function (e) {
                    ...
                    var i = function e(t) {
                        for (var n = t.childNodes, i = void 0, r = n.length, o = 0; o < r; o++) if (1 == n[o].nodeType && /^navPoint$/i.test(n[o].tagName)) {
                            var a = n[o],
            ...
            if (i) for (var r = function (t, r) {
                ...
                var a = o.getAttribute("href"), s = "href";
                if (!a) {
                ...
                sML.forEach(_.Items)((function (e) {
                    if (d == e.AnchorPath) return o.setAttribute("data-bibi-original-href", a), o.setAttribute(s, A.Path + "/" + l), o.InNav = n, o.Destination = {ItemIndex: e.Index}, "pre-paginated" == e["rendition:layout"] ? o.Destination.PageIndexInItem = 0 : p && (o.Destination.ElementSelector = "#" + p), k.coordinateLinkages.setJump(o), "break"
            ...
            return e.addEventListener("click", (function (t) {
                return t.preventDefault(), t.stopPropagation(), e.Destination && new Promise((function (t) {
                    ...
                    return k.Opened ? (H.History.add(), _.focusOn({
                        ...
                        return H.History.add({UI: A, SumUp: !1, Destination: e})
            ...
            var e = [], t = [], n = function (n, i) {
                return e.push(U.file(n, {Preprocess: !0, URI: i}).then((function () {
                    return t.push(n)
                })))
            };
            if (A.ExtractionPolicy) for (var i in A.Package.Manifest) {
            ...
            return new Promise((function (n, i) {
                ...
                e.Items.forEach((function (i) {
                    k.loadItem(i, {IsPlaceholder: t.AllowPlaceholderItems}).then((function () {
                        return r++
                    })).catch((function () {
                        return o++
                    })).then((function () {
            ...
            return i.classList.remove("loaded"), i.classList.toggle("placeholder", e.IsPlaceholder), e.Loading = (e.IsPlaceholder ? Promise.reject() : e.ContentURL ? Promise.resolve() : /\.(html?|xht(ml)?|xml)$/i.test(e.Source.Path) ? U.file(e.Source, {
                ...
                initialize: function () {
                    F["allow-scripts-in-content"] || (e.Source.Content = e.Source.Content.replace(/<script(\s+[\w\-]+(\s*=\s*('[^'']*'|"[^""]*"))?)*\s*\/>/gi, ""), U.sanitizeItemSource(e.Source, {As: "HTML"}))
                }
            }).then((function (e) {
                return e.Content
            })) : /\.(gif|jpe?g|png)$/i.test(e.Source.Path) ? U.file(e.Source, {URI: !0}).then((function (t) {
                ...
                initialize: function () {
                    var t = /<\?xml-stylesheet\s*(.+?)\s*\?>/g, n = e.Source.Content.match(t);
                    F["allow-scripts-in-content"] || U.sanitizeItemSource(e.Source, {As: "SVG"}), e.Source.Content = (n ? n.map((function (e) {
            ...
            return new Promise((function (t) {
                ...
                var i = getComputedStyle(e.HTML), r = getComputedStyle(e.Body);
                i[U.WritingModeProperty] != r[U.WritingModeProperty] && (e.HTML.style.writingMode = r[U.WritingModeProperty]), e.WritingMode = U.getWritingMode(e.HTML), /-rl$/.test(e.WritingMode) ? e.HTML.classList.add("bibi-vertical-text") : /-lr$/.test(e.WritingMode) && e.HTML.classList.add("bibi-horizontal-text"), [[e.Box, i, e.HTML], [e, r, e.Body]].forEach((function (e) {
        ...
        var _ = {
            ...
            createSpine: function (e) {
                _.Main = U.Body.insertBefore(sML.create("main", {id: "bibi-main"}), U.Body.firstElementChild), _.Main.Book = _.Main.appendChild(sML.create("div", {id: "bibi-main-book"})), _.Main.Book.appendChild(e)
            },
            ...
            layOutSpread: function (e) {
                ...
                return new Promise((function (n) {
                    ...
                    var i = {Width: 0, Height: 0}, r = e.Box;
                    if (1 == e.Items.length) {
                        var o = e.Items[0];
            ...
            renderReflowableItem: function (e) {
                var t, n, i, r = F["item-padding-" + z.L_BASE_s] + F["item-padding-" + z.L_BASE_e],
                    o = F["item-padding-" + z.L_BASE_b] + F["item-padding-" + z.L_BASE_a], a = _.Stage[z.L_SIZE_B] - r,
                    s = _.Stage[z.L_SIZE_L] - o, c = o;
                ...
                switch (e.Outsourcing || ("x" == F["pagination-method"] ? "paged" == F.RVM && e.HTML["offset" + z.L_SIZE_L] > s ? f = "S" : e.HTML["offset" + z.L_SIZE_B] > a && (f = "C") : ("paged" == F.RVM || e.HTML["offset" + z.L_SIZE_B] > a) && (f = "C")), f) {
                    case"S":
                        ...
                        var M = x.createElement("bibi-neck"), E = M.appendChild(x.createElement("bibi-throat")),
                            B = E.attachShadow ? E.attachShadow({mode: "open"}) : E.createShadowRoot ? E.createShadowRoot() : E;
            ...
            renderPrePaginatedItem: function (e) {
                ...
                var t = _.Stage[z.L_SIZE_B], n = _.Stage[z.L_SIZE_L];
                ...
                var i = null;
                if (e.Spreaded) if (i = _.getItemLayoutViewport(e), e.SpreadPair) {
                    var r = e.SpreadPair;
                    r.Spreaded = !0, r.Viewport || (r.Viewport = _.getItemViewport(r));
                    var o = _.getItemLayoutViewport(r), a = null, s = null, c = null, l = null;
                ...
                var p = Math.floor(i[z.L_SIZE_L] * e.Scale), f = Math.floor(i[z.L_SIZE_B] * (p / i[z.L_SIZE_L]));
            ...
            replacePages: function (e, t) {
                ...
                if (o != r) for (var c = o - r, l = e[r - 1].Index + 1; _.Pages[l];) _.Pages[l].Index += c, l++;
            ...
            layOutBook: function (e) {
                return new Promise((function (t, n) {
                    ...
                    H.ScrollObserver.History = [], _.LayingOut = !0, U.log("Laying out...", "<g:>"), e ? U.log("Option: %O", e) : e = {}, e.DoNotCloseUtilities || W.dispatch("bibi:closes-utilities"), W.dispatch("bibi:is-going-to:lay-out", e), U.Busy = !0, U.HTML.classList.add("busy"), U.HTML.classList.add("laying-out"), e.NoNotification || H.note("Laying out..."), e.Destination || (e.Destination = {IIPP: H.PageObserver.getIIPP()}), e.Setting && F.update(e.Setting);
                    var i = {};
            ...
            updateOrientation: function () {
                var e = _.Orientation;
                if (void 0 !== window.orientation) _.Orientation = 0 == window.orientation || 180 == window.orientation ? "portrait" : "landscape"; else {
            ...
            changeView: function (e) {
                ...
                F["keep-settings"] && U.Biscuits && U.Biscuits.memorize("Book", {RVM: e.Mode})
            }
        };
        Object.defineProperties(_, {
            ...
            if ("number" == typeof e || "string" == typeof e && /^\d+$/.test(e)) return {Page: _.Items[e].Pages[0]};
            if ("string" == typeof e) "head" == e || "foot" == e ? e = {Edge: e} : X.EPUBCFI && (e = X.EPUBCFI.getDestination(e)); else if ("number" == typeof e.IndexInItem) {
            ...
            if (/^[a-z]+$/.test(e)) return "head" == e || "foot" == e ? {Edge: e} : null;
            var t = e.split(/-[a-z]+$/.test(e) ? "-" : "."), n = parseInt(t.shift()) - 1;
            if (n < 0) return {Edge: "head"};
            if (n > _.Items.length - 1) return {Edge: "foot"};
            var i = _.Items[n];
            if (t.length) if (/^[a-z]+$/.test(t[0])) {
            ...
            return new Promise((function (t, n) {
                ...
                var i = (e.Distance > 0 ? H.PageObserver.Current.List.slice(-1) : H.PageObserver.Current.List)[0],
                    r = i.Page, o = (r.Item, e.Distance > 0 ? "before" : "after");
        ...
        H.Utilities = {
            ...
            create: function () {
                var e = H.ScrollObserver = {
                    History: [], Count: 0, onScroll: function (t) {
                ...
                var e = H.PageObserver = {
                    ...
                    getCandidatePageList: function () {
                        for (var t = Math.ceil((_.Stage.Width - 1) / 4), n = Math.ceil((_.Stage.Height - 1) / 4), i = [5, 6, 4, 2, 8], r = i.length, o = 0; o < r; o++) {
                            var a = i[o], s = document.elementFromPoint(t * (a % 3 || 3), n * Math.ceil(a / 3));
                            if (s) {
                    ...
                    getList: function () {
                        var t = [], n = [], i = e.getCandidatePageList();
                        ...
                        for (var r = sML.limitMin(i[0].Index - 2, 0), o = sML.limitMax(i[i.length - 1].Index + 2, _.Pages.length - 1), a = 0, s = r; s <= o; s++) {
                            var c = _.Pages[s], l = e.getIntersectionStatus(c, "WithDetail");
                            if (l.Ratio < a) {
                                if (t.length) break
                            } else {
                    ...
                    getIntersectionStatus: function (t, n) {
                        var i = sML.getCoord(t), r = z.L_AXIS_D,
                            o = Math.min(e.Current.Frame.After * r, i[z.L_BASE_A] * r) - Math.max(e.Current.Frame.Before * r, i[z.L_BASE_B] * r),
                            a = o <= 0 || !i[z.L_SIZE_L] || isNaN(o) ? 0 : o / i[z.L_SIZE_L], s = {Ratio: a};
                        if (a <= 0) ; else if (n) if (a >= 1) s.Contained = !0; else {
                            var c = e.Current.Frame.Before * r, l = e.Current.Frame.After * r, u = i[z.L_BASE_B] * r,
                                d = i[z.L_BASE_A] * r;
                    ...
                    classify: function () {
                        var t = [], n = _.Main.Book.querySelectorAll(".current");
                        e.Current.List.forEach((function (e) {
                            var n = e.Page, i = n.Item.Box, r = n.Spread.Box;
                    ...
                    observePageMove: function () {
                        W.bind("bibi:scrolled", (function () {
                            var t = e.Current.List[0], n = e.Current.List.slice(-1)[0], i = t.Page, r = n.Page,
                                o = t.PageIntersectionStatus, a = n.PageIntersectionStatus, s = e.Past.List[0],
                                c = e.Past.List.slice(-1)[0], l = s.Page, u = c.Page, d = _.Pages.length - 1, p = !1,
                                f = !1, g = !1;
                            if (i != l || r != u) p = !0, 0 == i.Index && (o.Contained || o.Headed) && (f = !0), r.Index == d && (a.Contained || a.Footed) && (g = !0); else {
                                var h = s.PageIntersectionStatus, b = c.PageIntersectionStatus;
                    ...
                    getP: function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = null, i = null;
                        if (t.Element && t.Element.ownerDocument && t.Element.ownerDocument.body.Item) n = t.Element.ownerDocument.body.Item, i = t.Element; else {
                            if ("pre-paginated" == A.Package.Metadata["rendition:layout"]) return {P: String((e.Current.Pages[0] || _.Pages[0]).Item.Index + 1)};
                            ...
                            var o = U.getElementCoord(r, _.Main),
                                a = {Left: o.X, Right: o.X + r.offsetWidth, Top: o.Y, Bottom: o.Y + r.offsetHeight};
                            ...
                            var s = U.getElementCoord(n, _.Main),
                                c = {Left: s.X + F["item-padding-left"], Top: s.Y + F["item-padding-top"]};
                            ...
                            e:for (var g = u[z.A_BASE_B], h = Math.round((u[z.A_BASE_A] - u[z.A_BASE_B]) / 9); g * d < u[z.A_BASE_A] * d; g += h) for (var b = u[z.A_BASE_S], m = Math.round((u[z.A_BASE_E] - u[z.A_BASE_S]) / 3); b * p < u[z.A_BASE_E] * p; b += m) {
                                var v = f(g, b);
                    ...
                    turnItems: function (t) {
                        if (!_.DoNotTurn && F["allow-placeholders"]) {
                            ...
                            if (i) {
                                var r = [i], o = [], a = [], s = _.Items[i.Index + n];
                                s && r.push(s);
                                ...
                                e.TurningItems_FaceUp.forEach((function (t) {
                                    ...
                                    return e.turnItem(t, {Up: !0, Delay: (r.includes(t) ? 99 : 999) * n})
                                }))
                            }
                        }
                    },
                    turnItem: function (t, n) {
                        return new Promise((function (i) {
                            if (!_.DoNotTurn && F["allow-placeholders"]) {
                                if (t || (t = e.getTurningOriginItem()), "object" != I(n) && (n = {Up: !0}), n.Up) {
                                ...
                                t.Timer_Turn = setTimeout((function () {
                                    return k.loadItem(t, {IsPlaceholder: !n.Up}).then((function () {
                                        n.Up ? e.TurningItems_FaceUp = e.TurningItems_FaceUp.filter((function (e) {
                                            ...
                                            return _.layOutSpread(t.Spread, {Makeover: !0, Reverse: n.Reverse})
                                        })).then((function () {
                                            return i(t)
                                        }))
                                    }))
            ...
            create: function () {
                var e = H.ResizeObserver = {
                    Resizing: !1, TargetPageAfterResizing: null, onResize: function (t) {
                ...
                var e = H.TouchObserver = {
                                    ...
                                    if (this.care(t), this.Touching) {
                                        ...
                                        if (r - this.Touching.Time < n.D2U) {
                                            ...
                                            if (Math.abs(o.X - this.Touching.Coord.X) < 3 && Math.abs(o.Y - this.Touching.Coord.Y) < 3) {
                                                var a = 0, s = {Time: r, Event: t, PreviousTouching: this.Touching};
                                                this.Floating ? (a = this.Floating.WaitingFor, this.Floating = Object.assign(s, {WaitingFor: ++this.Floating.WaitingFor})) : (a = 1, this.Floating = Object.assign(s, {WaitingFor: 2})), this.Timer_forgetFloating = setTimeout((function () {
                                                    delete i.Floating
                    ...
                    activateHTML: function (t) {
                        ...
                        W.add(t, "bibi:tapped", (function (e) {
                            ...
                            var n = U.getBibiEventCoord(t), i = e.PreviousPointerCoord;
                ...
                var e = H.FlickObserver = {
                    Moving: 0, getDegree: function (e) {
                        ...
                        if (H.ScrollObserver.breakCurrentScrolling(), e.StartedAt) {
                            ...
                            var i = U.getBibiEventCoord(t), r = {X: i.X - e.StartedAt.X, Y: i.Y - e.StartedAt.Y};
                            if (++e.Moving <= 3) {
                                var o = e.getDegree(r);
                                e.StartedAt.LaunchingAxis = 315 <= o || o <= 45 || 135 <= o && o <= 225 ? "X" : 45 < o && o < 135 || 225 < o && o < 315 ? "Y" : ""
                            }
                            if (e.StartedAt.LaunchingAxis == z.A_AXIS_B) ; else {
                            ...
                            if (t.preventDefault(), e.StartedAt.Item && (e.StartedAt.Item.HTML.classList.add("bibi-flick-hot"), e.StartedAt.Item.contentWindow.getSelection().empty()), e.LastEvent = t, i[z.A_AXIS_L] <= 0 || i[z.A_AXIS_L] >= _.Stage[z.A_SIZE_L] || i[z.A_AXIS_B] <= 0 || i[z.A_AXIS_B] >= _.Stage[z.A_SIZE_B]) return e.onTouchEnd(t, {Swipe: !0})
                        }
                        ...
                        var i = void 0, r = {};
                        if (e.StartedAt) {
                            var o = U.getBibiEventCoord(t), a = {X: o.X - e.StartedAt.X, Y: o.Y - e.StartedAt.Y};
                        ...
                        if (o) {
                            if ("paged" == F.RVM || F.RVM != (/^[lr]/.test(r) ? "horizontal" : /^[tb]/.test(r) ? "vertical" : "")) {
                                ...
                                return _.focusOn({
                                    Destination: {Page: _.Pages[a + o] ? _.Pages[a + o] : _.Pages[a]},
                        ...
                        var n = t.Deg, i = 270 < n || n < 90 ? "left" : 90 < n && n < 270 ? "right" : "", r = z.d2d(i),
            ...
            create: function () {
                var e = H.WheelObserver = {
                    TotalDelta: 0, Turned: !1, Wheels: [], reset: function () {
                        ...
                        var n = Math.abs(t.deltaX) > Math.abs(t.deltaY) ? "X" : "Y", i = {}, r = e.Wheels, o = r.length;
            ...
            create: function () {
                var e = H.PinchObserver = {
                    Pinching: 0, getEventCoords: function (e) {
                        var t = e.touches[0], n = e.touches[1], i = (e.target.ownerDocument, t.screenX), r = t.screenY;
                        return {
                        ...
                        if (2 == t.touches.length && e.PinchStart) {
                            ...
                            clearTimeout(e.Timer_TransitionRestore), sML.style(_.Main, {transition: "none"}), H.Loupe.scale(e.PinchStart.Scale * n, {
                ...
                if (F["use-keys"]) {
                    var e = H.KeyObserver = {
                        ...
                        updateKeyParameters: function () {
                            var t = H.orthogonal("arrow-keys"), n = function () {
                                switch (F.ARA) {
                                    case"horizontal":
            ...
            create: function () {
                ...
                W.add("bibi:opened", (function () {
                    W.add(["bibi:tapped-not-center", "bibi:doubletapped-not-center"], (function (e) {
                        if (H.isPointerStealth()) return !1;
                        var t = U.getBibiEvent(e), n = H.Flipper.getDirection(t.Division), i = H.orthogonal("edges"),
                            r = z.d2d(n, "move" == i);
                        if (r) H.Arrows && H.Arrows.areAvailable(t) && W.dispatch(H.Arrows[r], "bibi:tapped", e), H.Flipper.isAbleToFlip(r) && H.Flipper.flip(r); else if ("string" == typeof z.DDD[n]) switch (i) {
                            case"utilities":
                        ...
                        if (H.Arrows.areAvailable(n)) {
                            var i = H.Flipper.getDirection(n.Division), r = H.orthogonal("edges"),
                                o = z.d2d(i, "move" == r);
            ...
            create: function () {
                var e = H.Veil = H.setToggleAction(U.Body.appendChild(sML.create("div", {id: "bibi-veil"})), {
                    onopened: function () {
                ...
                var t = (U.TouchOS ? "Tap" : "Click") + " to Open", n = e.PlayButton = e.appendChild(sML.create("p", {
                    id: "bibi-veil-play",
                    title: t,
                    ...
                    hide: function () {
                        return sML.style(n, {opacity: 0, cursor: "default"}).then((function (t) {
                ...
                }, e.Cover = e.appendChild(sML.create("div", {id: "bibi-veil-cover"})), e.Cover.Info = e.Cover.appendChild(sML.create("p", {id: "bibi-veil-cover-info"})), W.dispatch("bibi:created-veil")
            }
        }, H.Catcher = {
            create: function () {
                if (!F["book-data"] && !F.book && F["accept-local-file"]) {
                    var e = H.Catcher = U.Body.appendChild(sML.create("div", {id: "bibi-catcher"}));
                    ...
                    })[U.Language]), e.title = e.querySelector("span").innerHTML.replace(/<br( ?\/)?>/g, "\n").replace(/<[^>]+>/g, "").trim(), e.Input = e.appendChild(sML.create("input", {type: "file"})), !F["extract-if-necessary"].includes("*") && F["extract-if-necessary"].length) {
                        var t = [];
            ...
            create: function () {
                ...
                var e = H.Menu = U.Body.appendChild(sML.create("div", {id: "bibi-menu"}, H.Menu));
            ...
            create: function () {
                ...
                if (F["fix-reader-view-mode"] || t.push("ViewModeSection"), U.Embedded && t.push("NewWindowButton"), U.FullscreenTarget && !U.TouchOS && t.push("FullscreenButton"), F["website-href"] && /^https?:\/\/[^\/]+/.test(F["website-href"]) && F["website-name-in-menu"] && t.push("WebsiteLink"), F["remove-bibi-website-link"] || t.push("BibiWebsiteLink"), t.length) {
                    var n = e.Config = sML.applyRtL(H.createSubpanel({id: "bibi-subpanel_config"}), e.Config);
                    delete n.create;
            ...
            create: function () {
                var e, t, n = H.Menu.Config,
                    ...
                    r = n.ViewModeSection = n.addSection({
                        Labels: {default: {default: "View Mode", ja: "閲覧モード"}}, ButtonGroups: [{
                            ButtonType: "radio",
                            Buttons: [{
                                Mode: "paged",
                                ...
                                return sML.edit(e, {
                                    Notes: !0, action: function () {
                                        return _.changeView({Mode: e.Mode, NoNotification: !0})
                                    }
                                })
                            }))
                        }, {
                            Buttons: [{
                                ...
                                action: function () {
                                    ...
                                    F.update({"full-breadth-layout-in-scroll": e}), e ? U.HTML.classList.add("book-full-breadth") : U.HTML.classList.remove("book-full-breadth"), "horizontal" != F.RVM && "vertical" != F.RVM || _.changeView({
                                        Mode: F.RVM,
                                        Force: !0
                                    }), F["keep-settings"] && U.Biscuits && U.Biscuits.memorize("Book", {FBL: F["full-breadth-layout-in-scroll"]})
                                }
                            }]
                        }]
                    });
            ...
            create: function (e) {
                ...
                (e.includes("WebsiteLink") && n.push({
                    Type: "link",
                    Labels: {default: {default: F["website-name-in-menu"].replace(/&/gi, "&amp;").replace(/</gi, "&lt;").replace(/>/gi, "&gt;")}},
                    Icon: '<span class="bibi-icon bibi-icon-open-newwindow"></span>',
                    href: F["website-href"],
                    target: "_blank"
            ...
            create: function () {
                var e = H.Panel = U.Body.appendChild(sML.create("div", {id: "bibi-panel"}));
                H.setToggleAction(e, {
                    onopened: function () {
                ...
                }), W.add("bibi:commands:open-panel", e.open), W.add("bibi:commands:close-panel", e.close), W.add("bibi:commands:toggle-panel", e.toggle), W.add("bibi:closes-utilities", e.close), H.setFeedback(e, {StopPropagation: !0}), W.add(e, "bibi:tapped", (function () {
            ...
            create: function () {
                var e = H.Help = U.Body.appendChild(sML.create("div", {id: "bibi-help"}));
            ...
            create: function () {
                ...
                if (("number" != typeof e.Step || e.Step < -2 || 2 < e.Step) && (e.Step = 0), W.bind("bibi:postprocessed-item", (function (t) {
                    ...
                    }, t.FontSize = {Default: 1 * getComputedStyle(t.HTML).fontSize.replace(/[^\d]*$/, "")}, t.FontSize.Base = t.FontSize.Default, t.Source.Preprocessed && (sML.UA.Chrome || sML.UA.Trident) ? sML.forEach(t.HTML.querySelectorAll("body, body *"))((function (e) {
                    ...
                    "pre-paginated" != F.BRL && t != e.Step && (n || (n = {}), W.dispatch("bibi:changes-font-size"), "function" == typeof n.before && n.before(), e.Step = t, F["use-font-size-changer"] && F["keep-settings"] && U.Biscuits && U.Biscuits.memorize("Book", {FontSize: {Step: t}}), setTimeout((function () {
                        _.layOutBook({
                            before: function () {
                            ...
                            W.dispatch("bibi:changed-font-size", {Step: t}), "function" == typeof n.after && n.after()
                        }))
                    }), 88))
                    ...
                    }).addSection({Labels: {default: {default: "Choose Font Size", ja: "文字サイズを選択"}}}).addButtonGroup({
                        ButtonType: "radio",
                        Buttons: [{
                            Labels: {
                                default: {
                ...
                var e = H.Loupe = {
                    ...
                    defineZoomOutPropertiesForUtilities: function () {
                        var t = F["use-menubar"] && F["use-full-height"] ? H.Menu.Height : 0,
                            n = "vertical" == F.ARA ? H.Slider.Size : 0, i = "horizontal" == F.ARA ? H.Slider.Size : 0,
                            r = {};
                        ...
                        var o = U.Body["offset" + z.A_SIZE_L] / r.Scale - _.Main["offset" + z.A_SIZE_L], a = {};
                    ...
                    transform: function (t) {
                        ...
                        return new Promise((function (i, r) {
                            ...
                            sML.style(_.Main, {transform: (s = [], c.TranslateX && c.TranslateY ? s.push("translate(" + c.TranslateX + "px, " + c.TranslateY + "px)") : c.TranslateX ? s.push("translateX(" + c.TranslateX + "px)") : c.TranslateY && s.push("translateY(" + c.TranslateY + "px)"), 1 != c.Scale && s.push("scale(" + c.Scale + ")"), s.length ? s.join(" ") : "")}), e.Timer_onTransformEnd = setTimeout((function () {
                    ...
                    scale: function (t) {
                        ...
                        var r = 0, o = 0;
                        if (t < 1) r = _.Main.offsetWidth * (1 - t) / 2, o = _.Main.offsetHeight * (1 - t) / 2; else if (t > 1) {
                    ...
                    transformForUtilities: function (t) {
                        ...
                        return e.transform(null, {Temporary: !0}).then(n).then((function () {
                    ...
                    onTap: function (t, n) {
                        ...
                        return e.CurrentTransformation.Scale >= F["loupe-max-scale"] && !t.shiftKey ? e.scale(1) : e.scale(e.CurrentTransformation.Scale * (t.shiftKey ? 1 / F["loupe-scale-per-step"] : F["loupe-scale-per-step"]), {Center: i.Coord})
                    },
                    ...
                    onPointerMove: function (t) {
                        ...
                        var n = U.getBibiEvent(t);
                        clearTimeout(e.Timer_TransitionRestore), sML.style(_.Main, {transition: "none"}, {cursor: "move"}), e.transform({
                            Scale: e.CurrentTransformation.Scale,
                    ...
                    var e = H.Nombre = U.Body.appendChild(sML.create("div", {
                        ...
                        progress: function (t) {
                            if (e.clearTimers(), t || (t = H.PageObserver.Current), t.List.length) {
                                var n, i = t.List[0].Page.Index + 1, r = t.List.slice(-1)[0].Page.Index + 1,
            ...
            create: function () {
                ...
                var e = H.Slider = U.Body.appendChild(sML.create("div", {
                    id: "bibi-slider", RailProgressMode: "end", Size: H.Slider.Size, initialize: function () {
                        var t = e.appendChild(sML.create("div", {id: "bibi-slider-edgebar-box"}));
                        e.Edgebar = t.appendChild(sML.create("div", {id: "bibi-slider-edgebar"})), e.Rail = t.appendChild(sML.create("div", {id: "bibi-slider-rail"})), e.RailGroove = e.Rail.appendChild(sML.create("div", {id: "bibi-slider-rail-groove"})), e.RailProgress = e.RailGroove.appendChild(sML.create("div", {id: "bibi-slider-rail-progress"})), e.Thumb = t.appendChild(sML.create("div", {
                            id: "bibi-slider-thumb",
                            Labels: {default: {default: "Slider Thumb", ja: "スライダー上の好きな位置からドラッグを始められます"}}
                        })), H.setFeedback(e.Thumb), F["use-history"] && (e.classList.add("bibi-slider-with-history"), e.History = e.appendChild(sML.create("div", {id: "bibi-slider-history"})), e.History.add = function (t) {
                            return H.History.add({UI: e, SumUp: !1, Destination: t})
                            ...
                            e.Touching || H.Nombre.progress({List: [{Page: e.getPointedPage(U.getBibiEventCoord(t)[z.A_AXIS_L])}]})
                        ...
                        if (e.Touching) {
                            ...
                            sML.style(e.Thumb, {transform: "translate" + z.A_AXIS_L + "(" + i + "px)"}), sML.style(e.RailProgress, d({}, z.A_SIZE_l, e.StartedAt.RailProgressLength + i * ("rtl" == F.ARD ? -1 : 1) + "px"))
                        }
                        ...
                        if (e.Touching) {
                            ...
                            n == e.StartedAt.Coord && (e.StartedAt.Coord = e.StartedAt.ThumbBefore + e.Thumb.Length / 2), _.DoNotTurn = !1, e.flip(n, "FORCE").then((function () {
                                sML.style(e.Thumb, {transform: ""}), sML.style(e.RailProgress, d({}, z.A_SIZE_l, "")), e.progress(), e.History && e.History.add()
                        ...
                        var n = (t - e.Edgebar.Before) / e.Edgebar["offset" + z.A_SIZE_L],
                            ...
                            o = _.Pages[i], a = e.getPageDistanceFromPoint(o, r);
                        return [-1, 1].forEach((function (t) {
                            for (var n = i + t; _.Pages[n]; n += t) {
                                var s = _.Pages[n], c = e.getPageDistanceFromPoint(s, r);
                                if (!(c < a)) break;
                                o = s, a = c
                            }
                        })), o
                ...
                var t = "div#bibi-slider", n = "html.appearance-horizontal " + t, i = U.Scrollbars.Height,
                    r = Math.ceil(i / 2), o = "html.appearance-vertical " + t, a = U.Scrollbars.Width,
                        ...
                        Bookmarks: [], initialize: function () {
                            e.Subpanel = H.createSubpanel({
                                Opener: H.Menu.L.addButtonGroup({
                                    ...
                                    Help: !0
                                }), Position: "left", id: "bibi-subpanel_bookmarks", updateBookmarks: function () {
                                    return e.update()
                                }, onopened: function () {
                            ...
                            for (var n = e.Bookmarks.length, i = 0; i < n; i++) if (e.Bookmarks[i].IIPP == t.IIPP) return e.Bookmarks[i];
                            return null
                        }, add: function (t) {
                            ...
                            if (Array.isArray(t.Bookmarks) && (e.Bookmarks = t.Bookmarks), t.Added ? n = [t.Added] : k.Opened && (H.PageObserver.updateCurrent(), n = H.PageObserver.Current.Pages.map((function (e) {
                                ...
                                for (var r = [], o = function (t, o) {
                                    var a = e.Bookmarks[o];
                                    if ("number" == typeof a) a = {IIPP: a}; else {
                                    ...
                                    var s = "", c = "", l = "bibi-bookmark", u = _.hatchPage(a), d = 0;
                                    ...
                                    var f = e.ButtonGroup.addButton({
                                        ...
                                        Bookmark: a,
                                        action: function () {
                                            return k.Opened ? _.focusOn({Destination: a}).then((function (t) {
                                                return H.History.add({UI: e, SumUp: !1, Destination: t})
                                            })) : !!k.Waiting && (F["start-in-new-window"] ? k.openNewWindow(location.href + (location.hash ? "&" : "#") + "jo(iipp=" + a.IIPP + ")") : (_.StartOn = {IIPP: a.IIPP}, void k.play()))
                                        },
                                        remove: function () {
                                            return e.remove(a)
                                        }
                                    ...
                                    H.setFeedback(g, {StopPropagation: !0}), W.add(g, "bibi:tapped", (function () {
                                        return f.remove()
                            ...
                            }), n.length && !i.length || H.setUIState(e.AddButton, "disabled")), U.Biscuits.memorize("Book", {Bookmarks: e.Bookmarks}), W.dispatch("bibi:updated-bookmarks", e.Bookmarks), t.Added && W.dispatch("bibi:added-bookmark", e.Bookmarks), t.Removed && W.dispatch("bibi:removed-bookmark", e.Bookmarks)
                        }
                    };
            ...
            create: function () {
                var e = H.Flipper = {
                    PreviousDistance: 0, Back: {Distance: -1}, Forward: {Distance: 1}, getDirection: function (e) {
                        switch (F.ARA) {
                            case"horizontal":
                        ...
                        return _.moveBy({Distance: t, Duration: n.Duration}).then((function (t) {
            ...
            create: function () {
                for (var e = H.Spinner = U.Body.appendChild(sML.create("div", {id: "bibi-spinner"})), t = 1; t <= 12; t++) e.appendChild(document.createElement("span"));
            ...
            return r.Buttons = [], r.addButton = function (e) {
                ...
                return t ? (t.ButtonGroup = this, t.ButtonBox = t.ButtonGroup.appendChild(sML.create("li", {className: "bibi-buttonbox bibi-buttonbox-" + t.Type})), U.TouchOS || (H.TouchObserver.observeElementHover(t.ButtonBox), H.TouchObserver.setElementHoverActions(t.ButtonBox)), t.ButtonBox.appendChild(t), t.ButtonGroup.Buttons.push(t), t) : null
            ...
            return n.Icon && (n.IconBox = n.appendChild(sML.create("span", {className: "bibi-button-iconbox"})), n.IconBox.appendChild(n.Icon), n.Icon = n.IconBox.firstChild, n.IconBox.Button = n.Icon.Button = n), n.Label = n.appendChild(sML.create("span", {className: "bibi-button-label"})), H.setFeedback(n, {
                Help: e.Help,
                Checked: e.Checked,
                StopPropagation: !0,
            ...
            return i.Labels && (i.Labels = H.distillLabels(i.Labels), i.appendChild(sML.create("div", {className: "bibi-hgroup"})).appendChild(sML.create("p", {className: "bibi-h"})).appendChild(sML.create("span", {
                className: "bibi-h-label",
                innerHTML: i.Labels.default[U.Language]
            }))), i.ButtonGroups = [], i.addButtonGroup = function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = H.createButtonGroup(e);
            ...
            return "object" == I(e) && e || (e = {default: e}), "string" != typeof e.default && ("string" == typeof e.en ? e.default = e.en : "string" == typeof e[U.Language] ? e.default = e[U.Language] : e.default = ""), "string" != typeof e[U.Language] && ("string" == typeof e.default ? e[U.Language] = e.default : "string" == typeof e.en ? e[U.Language] = e.en : e[U.Language] = ""), e
        ...
        x.at1st.List.unshift((function () {
            ...
            var e = x.applyFilteredSettingsTo({}, R, [x.SettingTypes, x.SettingTypes_UserOnly]), t = function () {
                var e = location.hash;
                if ("string" != typeof e) return {};
                var t = {}, n = e.match(new RegExp("([&#])([a-zA-Z_]+)\\(([^\\(\\)]+)\\)", "g"));
                for (var i in n && n.length && n.forEach((function (n) {
                    var i = n.match(new RegExp("([&#])([a-zA-Z_]+)\\(([^\\(\\)]+)\\)")), r = i[2].toLowerCase(),
                        o = i[3];
                    o && (r = "bibi" == r ? "Bibi" : "jo" == r ? "Jo" : "epubcfi" == r ? "EPUBCFI" : void 0) && (t[r] = o), e = e.replace(n, i[1])
                })), t["#"] = e.replace(/^#|&$/, ""), t) if ("EPUBCFI" != i) {
            ...
            Object.assign(R, e), "number" == typeof R.nav ? R.nav < 1 ? delete R.nav : _.StartOn = {Nav: R.nav} : "string" == typeof R.p ? _.StartOn = {P: R.p} : "number" == typeof R.iipp ? _.StartOn = {IIPP: R.iipp} : "string" == typeof R.edge ? _.StartOn = {Edge: R.edge} : "string" == typeof R.EPUBCFI && W.add("bibi:readied", (function () {
        ...
        var N = {
            ...
            initialize: function () {
                ...
                if ("object" == I(e)) for (var i in e) "function" != typeof F[i] && (F[i] = e[i]);
                for (var r in F["book-rendition-layout"] = A.Package.Metadata["rendition:layout"], F["allow-placeholders"] = F["allow-placeholders"] && A.AllowPlaceholderItems, F.FontFamilyStyleIndex && sML.deleteCSSRule(F.FontFamilyStyleIndex), F["ui-font-family"] && (F.FontFamilyStyleIndex = sML.appendCSSRule("html", "font-family: " + F["ui-font-family"] + " !important;")), F["page-progression-direction"] = A.PPD, "x" == F["pagination-method"] ? F["spread-layout-axis"] = "vertical" == F["reader-view-mode"] ? "vertical" : "horizontal" : F["spread-layout-axis"] = function () {
                    ...
                    var o = F.Modes[r].CNP + "-", a = o + t[r], s = o + F[r];
            ...
            update: function () {
                z.probe("L", F["spread-layout-axis"]), z.probe("A", F["apparent-reading-axis"]), z.DDD = function () {
                    switch (F.PPD) {
                        case"ltr":
                            return "ttb" != F.ARD ? {left: -1, right: 1, top: "-1", bottom: "1"} : {
                                left: "-1",
                                right: "1",
                                top: -1,
                                bottom: 1
                ...
                "ltr" != F.PPD && n.reverse(), "horizontal" == t ? (z._app(e, "BASE", {
                    ...
                    s: "top",
                    e: "bottom"
                }), z._app(e, "SIZE", {b: "height", l: "width"}), z._app(e, "OOBL", {
                    b: "top",
                    l: "left"
                }), z._app(e, "OEBL", {b: "bottom", l: "right"}), z._app(e, "AXIS", {
                    b: "y",
                    l: "x"
                    ...
                    s: n[0],
                    e: n[1]
                }), z._app(e, "SIZE", {b: "width", l: "height"}), z._app(e, "OOBL", {
                    b: "left",
                    l: "top"
                }), z._app(e, "OEBL", {b: "right", l: "bottom"}), z._app(e, "AXIS", {
                    b: "x",
                    l: "y"
                }), z[e + "_AXIS_D"] = 1)
            }, _app: function (e, t, n) {
            ...
            log: function (e, t, n) {
                ...
                if ((e || i) && (U.log.Depth <= U.log.Limit || "<b:>" == r || "</b>" == r || "<*/>" == r)) {
                    var o = U.log.Depth <= 1 ? U.stamp(e) : 0, a = [], s = [];
                    if (e) switch (r) {
                        case"<b:>":
        ...
        U.log.initialize = function () {
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : U.TimeCard,
                n = Date.now() - x.TimeOrigin, i = U.getTimeLabel(n);
            ...
            for (var t = F["extract-if-necessary"].length, n = 0; n < t; n++) if (new RegExp(F["extract-if-necessary"][n].replace(/\./g, "\\.") + "$", "i").test(e)) return !0;
            return !1
        }, U.src = function (e) {
            ...
            return (e = U.src(e)).Retlieving ? e.Retlieving : e.Content ? Promise.resolve(e) : e.URI ? U.download(e) : e.Retlieving = U.RangeLoader.getBuffer(e.Path).then((function (t) {
                return U.isBin(e) ? (e.DataType = "Blob", e.Content = new Blob([t], {type: e["media-type"]})) : (e.DataType = "Text", e.Content = new TextDecoder("utf-8").decode(new Uint8Array(t))), e.Retlieved = !0, delete e.Retlieving, e
            })).catch((function (t) {
            ...
            var t = U.isBin(e), n = new XMLHttpRequest,
            ...
            return URL.createObjectURL("Text" == e ? new Blob([t], {type: n}) : t)
        }, U.ContentTypes = {
            pdf: "application/pdf",
            ...
            for (var t in U.ContentTypes) if (new RegExp("\\." + t + "$").test(e)) return U.ContentTypes[t];
            return null
        }, U.preprocess = function (e) {
            e = U.src(e);
            var t = [], n = U.preprocess.getSetting(e.Path);
            ...
            if (n.ReplaceRules && (e.Content = n.ReplaceRules.reduce((function (e, t) {
                ...
                n.ResolveRules.forEach((function (n) {
                    return n.Patterns.forEach((function (o) {
                        var a = n.getRE(o.Attribute), s = e.Content.match(a);
                        if (s) {
                            ...
                            s.forEach((function (o) {
                                ...
                                if (c.test(l[0])) {
                                    ...
                                    t.push(u), i.push(U.file(u, {Preprocess: !0, URI: !0}).then((function (t) {
            ...
            css: {
                ...
                ResolveRules: [{
                    ...
                    }, PathRef: "$1", Patterns: [{Extensions: "css"}]
                }, {
                    getRE: function () {
            ...
            svg: {
                ReplaceRules: [[/<!--\s+[.\s\S]*?\s+-->/gm, ""]], ResolveRules: [{
                    ...
                    PathRef: "$2",
                    Patterns: [{Attribute: "href", Extensions: "css"}, {
                        Attribute: "src",
                        Extensions: "svg"
            ...
            if (!e) return {};
            var t, n, i, r, o = U.getBibiEventCoord(e), a = F["flipper-width"],
            ...
            if (t == document) e.X -= U.Body.scrollLeft, e.Y -= U.Body.scrollTop; else {
                var n = _.Main, i = H.Loupe.CurrentTransformation || {Scale: 1, TranslateX: 0, TranslateY: 0},
                    r = i.Scale, o = n.offsetWidth / 2, a = n.offsetHeight / 2, s = i.TranslateX, c = i.TranslateY,
                    l = t.documentElement.Item, u = l.Scale, d = U.getElementCoord(l, n);
            ...
            Memories: {}, Labels: {}, initialize: function (e) {
                ...
                var n = U.Biscuits.Labels[e];
                if (t && "object" == I(t)) for (var i in t) {
                    var r = t[i];
                    try {
                ...
                if (e) if ("string" == typeof e && U.Biscuits.Labels[e]) {
                    var n = U.Biscuits.Labels[e];
                ...
                } else ; else localStorage.removeItem(U.Biscuits.Labels.Bibi), localStorage.removeItem(U.Biscuits.Labels.Book), U.Biscuits.Memories = {};
